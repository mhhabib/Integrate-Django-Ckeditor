"""
Django settings for djck project.
...
SECRET_KEY = 'django-insecure-n%598#b85lhfdnks3mq=bu_e46wpz!1yr0plz$^=c2y6r6pih$'
...
WSGI_APPLICATION = 'djck.wsgi.application'
