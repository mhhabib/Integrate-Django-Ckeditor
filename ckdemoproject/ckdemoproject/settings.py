"""
Django settings for ckdemoproject project.
...
SECRET_KEY = 'django-insecure-@@6bfuy1#8i$b%8j94i1r3dwg*4+5=p&=ldyv+85^g-+77&st!'
...
ROOT_URLCONF = 'ckdemoproject.urls'
...
WSGI_APPLICATION = 'ckdemoproject.wsgi.application'
